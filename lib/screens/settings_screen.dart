...
class _ProfileTabContentState extends State<_ProfileTabContent> {
  ...
  void initState() {
    super.initState();
    _nameController = TextEditingController(text: widget.provider.userData.name);
    _emailController = TextEditingController(text: widget.provider.userData.email);
  }
  ...
  void _handleSave() {
    widget.provider.updateUserData({
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      provider.userData.name.isNotEmpty 
