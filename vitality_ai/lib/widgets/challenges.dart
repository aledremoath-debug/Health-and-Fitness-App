...
class Challenges extends StatelessWidget {
  ...
  Widget _buildChallengeCard(_ChallengeData ch, UserProvider provider, bool isDark) {
      ...
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(ch.icon, color: ch.color, size: 20),
              ),
          ...
          TweenAnimationBuilder<double>(
            tween: Tween(begin: 0, end: ch.progress),
            ...
            builder: (context, value, child) {
              return ClipRRect(
                ...
                child: LinearProgressIndicator(
                  ...
                  valueColor: AlwaysStoppedAnimation<Color>(ch.color),
                ),
              );
            },
          ),
